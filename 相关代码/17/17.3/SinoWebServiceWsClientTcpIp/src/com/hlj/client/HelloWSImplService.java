 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://myws.hlj.com/", wsdlLocation = "file:/E:/WorkSpace/JspWorkSpace/MyeclipseWebService/SinoWebServiceWsClientTcpIp/hellows.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://myws.hlj.com/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/E:/WorkSpace/JspWorkSpace/MyeclipseWebService/SinoWebServiceWsClientTcpIp/hellows.wsdl");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://myws.hlj.com/", "HelloWSImplPort"), HelloWSImpl.class);
    }
    ...
    public HelloWSImpl getHelloWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myws.hlj.com/", "HelloWSImplPort"), HelloWSImpl.class, features);
    }
