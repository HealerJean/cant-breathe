...
public class JedisTwoWatch {
	 ...
	 * @throws InterruptedException 
	  ...
	  public static void main(String[] args) throws InterruptedException  {
	     JedisTwoWatch test = new JedisTwoWatch();
	 ...
	 */
	    jedis.watch("balance");
	    jedis.set("balance","12");//此句不该出现，讲课方便。模拟其他程序已经修改了该条目
	    System.out.println("我是其他人，我已经修改了balance 在你watch期间"); 
